...
const modules = [
  ...
  { id: "bottom-up",        label: "Bottom-up management" },
  { id: "motivation",       label: "Motivation" },
  { id: "change",           label: "Conduite du changement" },
];
  ...
  return (
    <main className="min-h-screen bg-white max-w-2xl mx-auto px-4">
      <div className="flex items-center gap-3 py-5 border-b border-gray-100">
        ...
        <div>
          <h1 className="font-medium text-gray-900 text-sm">Successful Manager Program</h1>
          <p className="text-xs text-gray-400">Formation managers · Strengths-based</p>
        </div>
      </div>
      ...
      <Chat
        ...
        agentId="smp"
        context={{ module }}
        placeholder="Pose ta question ou décris ta situation..."
        welcomeMessage="Quel défi de management tu veux explorer ? Sélectionne un module ci-dessus ou commence directement."
      />
    </main>
  );
}
